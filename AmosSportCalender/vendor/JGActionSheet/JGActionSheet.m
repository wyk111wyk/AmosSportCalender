...
- (void)setButtonStyle:(JGActionSheetButtonStyle)buttonStyle forButton:(UIButton *)button {
    ...
    else if (buttonStyle == JGActionSheetButtonStyleBlueText) {
        font = [UIFont systemFontOfSize:15.0f];
        titleColor = [UIColor colorWithRed:11.0/255 green:150.0/255 blue:246.0/255 alpha:1];
        
        backgroundColor = [UIColor colorWithWhite:0.98f alpha:1.0f];
        borderColor = [UIColor colorWithWhite:0.9f alpha:1.0f];
    }
    else if (buttonStyle == JGActionSheetButtonStyleGreenText) {
        font = [UIFont systemFontOfSize:15.0f];
        titleColor = [UIColor colorWithRed:0.0000 green:0.7059 blue:0.6784 alpha:1];
        
        backgroundColor = [UIColor colorWithWhite:0.98f alpha:1.0f];
        borderColor = [UIColor colorWithWhite:0.9f alpha:1.0f];
    }else if (buttonStyle == JGActionSheetButtonStyleRedText) {
        font = [UIFont systemFontOfSize:15.0f];
        titleColor = [UIColor colorWithRed:1.0000 green:0.4902 blue:0.4275 alpha:1];
        
        backgroundColor = [UIColor colorWithWhite:0.98f alpha:1.0f];
        borderColor = [UIColor colorWithWhite:0.9f alpha:1.0f];
    }else if (buttonStyle == JGActionSheetButtonStyleYellowText) {
        font = [UIFont systemFontOfSize:15.0f];
        titleColor = [UIColor colorWithRed:0.9529 green:0.7725 blue:0.1765 alpha:1];
